...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <header class="text-gray-600 body-font shadow">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <!-- Logo -->
        <a href="/" class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0 mr-6">
            <svg xmlns="http://www.w3.org/2000/svg"
                 ...
                 viewBox="0 0 24 24">
                <path d="M12 12c-1.3 0-2.5.8-3 2-.3.7-.1 1.5.4 2 .7.7 1.6 1 2.6 1s1.9-.3 2.6-1c.5-.5.7-1.3.4-2-.5-1.2-1.7-2-3-2z"/>
                <circle cx="5.5" cy="9.5" r="2.5"/>
                <circle cx="8.5" cy="5.5" r="2.5"/>
                <circle cx="15.5" cy="5.5" r="2.5"/>
                <circle cx="18.5" cy="9.5" r="2.5"/>
            </svg>
            <span class="ml-3 text-xl font-semibold">PETSHOP</span>
        </a>

        <!-- Menu -->
        <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center mr-6">
            <a href="/" class="mr-5 hover:text-indigo-600">Home</a>
            <a href="/about" class="mr-5 hover:text-indigo-600">Tentang Toko</a>
            <a href="/products" class="mr-5 hover:text-indigo-600">Produk</a>
        </nav>

        <!-- Cart -->
        <a href="{{ route('cart.index') }}"
           class="relative inline-flex items-center mr-5 text-gray-700 hover:text-indigo-600">
        ...
        <!-- Login -->
        <a href="/admin"
           class="inline-flex items-center bg-indigo-500 text-white
                  py-2 px-4 rounded hover:bg-indigo-600 transition">
            Login
            <svg fill="none" stroke="currentColor" stroke-width="2"
                 stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="flex flex-wrap md:text-left text-center order-first">
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          ...
          <li>
            <a class="text-gray-600 hover:text-gray-800">Detail Produk</a>
          </li>
        </nav>
      </div>
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
